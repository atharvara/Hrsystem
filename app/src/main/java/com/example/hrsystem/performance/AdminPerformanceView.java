...
public class AdminPerformanceView extends AppCompatActivity {
    ...
    private void viewPer(String  i) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, uRl, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(AdminPerformanceView.this, error.toString(), Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
        ...
        MySingleton.getmInstance(AdminPerformanceView.this).addToRequestQueue(request);
