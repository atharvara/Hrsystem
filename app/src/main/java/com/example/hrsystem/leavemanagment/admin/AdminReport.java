...
import com.example.hrsystem.leavemanagment.EmpView;
...
CustomProgressDialog customProgressDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customProgressDialog = new CustomProgressDialog(AdminReport.this);
        ...
        sdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(AdminReport.this,
    ...
    private void sendDates(String txtSdate, String txtEdate) {
        ...
        String uRl = "https://shinetech.site/shinetech.site/hrmskbp/leave/admin_report.php";
        StringRequest request = new StringRequest(Request.Method.POST, uRl, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(AdminReport.this, error.toString(), Toast.LENGTH_SHORT).show();
                //  progressDialog.dismiss();
                customProgressDialog.dismiss();
        ...
        MySingleton.getmInstance(AdminReport.this).addToRequestQueue(request);
